...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1160.1186148190152; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1913.0954771575985; // x position of the perpendicular encoder (in tick units)
    }
