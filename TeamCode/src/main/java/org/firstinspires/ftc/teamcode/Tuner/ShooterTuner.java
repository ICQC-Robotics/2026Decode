...
public class ShooterTuner extends OpMode {
    ...
    public static double coverPosition = 0.75;  // blocker stays open while tuning
    ...
    public void loop() {
        ...
        negabot.shooter.setHood(hoodPosition);
        negabot.shooter.setMagazineCover(coverPosition);
