...
public class BlueFarSideLastRow extends CommandOpMode {
    ...
    public void initialize() {
        ...
        waitForStart();
        negabot.schedule(
                new InstantCommand(() -> { negabot.shooter.setVelocity(4090);}),
    ...
    private Command branchOnLatchedZone() {
        return new SelectCommand(
                ...
                // selector: return the key at runtime
                () -> latchedZone
        );
    }
    ...
    public void path(Follower follower) {
        ...
        ZoneCGo = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(55.590, 18.612),
                                new Pose(39.363, 32.230),
                                new Pose(9.086, 30.890)
                        )
                ).setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
