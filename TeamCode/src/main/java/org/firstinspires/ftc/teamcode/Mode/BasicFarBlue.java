...
/**
 * Stripped-down BLUE teleop for far shooting: drive and intake work exactly like {@link SoloBlue},
 ...
 */
@Config
@TeleOp(name = "BasicFarBlue")
public class BasicFarBlue extends CommandOpMode {
    ...
    private final Pose blueReset = new Pose(32.848346636259976, 134.4310148232611, Math.toRadians(90));
    ...
    public void initialize() {
        ...
        negabot.Action(
                ...
                new InstantCommand(() -> negabot.drive.follower.setPose(blueReset)),
                null
        );
    }
